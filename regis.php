...
if(isset($_POST['submit'])){
    ...
    $emailquery=" select * from `mahal` where email='$email' ";
    ...
    if($emailcount>0){
        ...
        if($password === $cpassword){
            ...
            $newquery="INSERT INTO `taj`.`mahal` ( `username`, `email`, `phone number`, `password`, `cpassword`) VALUES ( '$username', '$email', '$mobile', '$pass', '$cpass')"; 
